...
import {
  ...
  UploadCloud, AlertCircle, X, Check, MoreVertical, BarChart3,
  ChevronRight, LayoutGrid, List, Bold, Image as ImageIcon, Mail, Phone
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-950 via-slate-900 to-slate-950 flex font-sans">
      ...
      <main className="flex-1 md:ml-72 p-4 md:p-12 overflow-x-hidden">
        <DashboardMobileHeader onLogout={onLogout} />
        {/* EDIT / ADD FORM MODE */}
        {
